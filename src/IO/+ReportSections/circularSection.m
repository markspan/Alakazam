...
%   See also ISCIRCULARTYPE, DESCRIPTIVEONLYREASON, DESCRIPTIVESECTION.
    ...
    lines = [{ ...
        ...
        ['Conditions: __BINLIST_MD__. ' ...
         ...
         'The mean angle is accompanied by a bootstrap interval over subjects. An ' ...
         'interval spanning a large part of the circle indicates angles close to ' ...
         'uniform, in which case the mean direction should not be reported.'] ...
        '' ...
        '```{r}' ...
