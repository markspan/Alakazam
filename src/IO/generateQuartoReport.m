...
%   top, costs a paragraph and prevents both.
    lines = { ...
        ...
        ['Each result below is stated as an **estimate first**: which condition was larger, ' ...
         ...
         'The interval indicates which effect sizes are compatible with these data; a ' ...
         '*p*-value indicates only whether zero is among them.'] ...
        '' ...
        ['**Primary and secondary tests.** The planned condition comparisons form one family ' ...
         ...
         'across them would enlarge the family with rows carrying no independent information, ' ...
         'which increases the severity of the adjustment without increasing the protection ' ...
         'it provides.'] ...
        '' ...
        ...
        '' ...
        ['**What is not claimed.** These tests were run on the windows, channels and ' ...
         ...
         'stated level. Pre-specification of the windows and channels, or replication in ' ...
...
%   filtered for it.
    ...
    lines = [ReportDoc.yamlHeader(['Alakazam ' reportTitle ' Statistical Report']), { ...
        ...
        '}' ...
        '' ...
        '# The effect itself. The plots above show the conditions; this shows the' ...
        '# difference between them, which is the quantity each test in this report' ...
        '# concerns and the one whose interval gives its magnitude. The bootstrap' ...
        '# distribution behind the interval is drawn rather than summarised, so a' ...
        '# skewed or multi-modal distribution is visible rather than concealed by' ...
        '# a symmetric-looking [lo, hi].' ...
        '#' ...
        '# The zero line is always drawn: an axis that excludes zero exaggerates' ...
        '# the apparent size of an effect, and the position of zero relative to' ...
        '# the interval is what the panel is for.' ...
