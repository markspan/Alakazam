...
%   GENERATESOURCEESTIMATEREPORTASSETS, REPORTSECTIONS.SOURCEESTIMATESECTION.
    ...
    parts = [{preambleText(csvFileName, reportTitle, groupColumn, hasGroups, plan, ...
                          grandAverageCsv, trialCsv, spectraCsv, coherenceCsvs)}, {readersGuideText(reportTitle)}, ...
...
function text = readersGuideText(reportTitle)
...
%   word for a block: frequencies in a spectral report, time windows otherwise.
    ...
    lines = { ...
        ...
        ['**Bayes factors** appear beside the *t*-tests because a non-significant *p* does not ' ...
         ...
         'Wagenmakers, 2013). They use the default JZS prior, a Cauchy distribution on the ' ...
         'effect size with scale sqrt(2)/2, as in JASP. Where the data departed from normality ' ...
         'and a rank-based test was reported instead, no Bayes factor is given, and beside a ' ...
         'Welch *t*-test the Bayes factor assumes equal variances, since no Welch form of it is ' ...
         'available.'] ...
        '' ...
