...
%   See also REPORTDESIGNPLAN, PAIREDSECTION, BETWEENSECTION.
    ...
    lines = [{ ...
        ...
        ['    bf <- bf10_effect(d, fixed_terms, "' view.headlineEffect '")'] ...
        ['    bf_list[[ch]] <- tibble(Channel = ch, Effect = "' view.headlineEffect '", BF10 = fmt_bf(bf), Evidence = bf_word(bf))'] ...
        ...
        'if (nrow(bf_all) > 0) {' ...
        ['  cat(as_raw_html(blank_missing(apa_gt(bf_all, "' view.bfTableTitle '"))))'] ...
        ['  cat(sprintf("\n*%s*\n\n", "' ReportSections.rLit(ReportSections.testCaption('lmm_bf')) '"))'] ...
        '}' ...
        '' ...
