...
%   frequency domain.
%
%   OUT = GaussianBandpass(DATA, SRATE, FREQ, FWHM) filters DATA along its
%   SECOND dimension (samples), for any number of rows (channels) and pages
%   (trials), by multiplying its Fourier transform by a Gaussian centred on
%   FREQ Hz with a full width at half maximum of FWHM Hz, mirrored onto the
%   negative frequencies so the result is real, and transforming back. The
%   gain is 1 at FREQ and 0.5 at FREQ +/- FWHM/2.
%
