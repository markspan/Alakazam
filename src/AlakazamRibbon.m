    ...
    methods (Access = private)
        ...
        %   the bundled sets); one clean, consistent icon per action now.
            items = { ...
                ...
                struct('id', 'editGroups', 'label', 'Edit Groups', ...
                    'tooltip', 'Assign subjects to between-subjects groups, for group comparisons in the Export/Report statistics reports', ...
