...
%   AverageView, SpectralMeasureView or CoherenceView -- the views with
%   wheel navigation) is on the active tile (see activeTileTag), if
...
%   setupMainWindow). See dispatchKey.
    ...
    for viewName = ["SignalView", "EpochView", "TimeFrequencyView", "ScalpDistributionView", ...
                    "AverageView", "SpectralMeasureView", "CoherenceView"]
