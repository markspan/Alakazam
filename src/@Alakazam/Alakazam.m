...
%   See also ALAKAZAMPLOTTER, EEGLABENVIRONMENT, WORKSPACE, BUILDTOOLBARALAKAZAM.
    ...
    methods (Access = private)
        ...
        p = templateParams(~, p)
        [newNode, resultEEG] = applyStepToTarget(this, transformId, params, targetNode, targetEEG)
        ...
        epochMs = candidateEpochMs(this, candidateFiles)
    ...
    methods
        ...
        evaluateDroppedBranch(this, sourceFile, targetNode, targetEEG)
        onListEvents(this)
        onRenameNode(this)
        onDeleteNode(this)
        closeTab(this, tag)
