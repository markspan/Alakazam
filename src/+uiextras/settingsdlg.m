...
% https://www.paypal.me/RodyO/3.5
    ...
    originalfontsize = get(0, 'defaultuicontrolfontsize');
...
edit_bgcolor = [.98 .98 .98];
    ...
    total_width   = getValue(325, 'WindowWidth')+20;
    ...
    total_height = numel(fields)*1.25*control_height + ... % to fit all controls
                     1.5*control_height + 50; % to fit "OK" and "Cancel" buttons
        ...
        while true
            ...
            if strcmpi(tags{ii}, 'Separator')
                ...
                uicontrol(...
                    ...
                    'fontweight', 'bold',...
                    'fontsize', fontsize+2,...
                    'position', [separator_offset_X,control_offset_Y, ...
    ...
    uicontrol(...
        ...
        'parent'  , fighandle,...
        'string'  , 'Cancel',...
        'position', [separator_offset_X,12, total_width/2.5,control_height*1.5],...
        'Callback', @Cancel)
    ...
    uicontrol(...
        ...
        'parent'  , fighandle,...
        'string'  , 'OK',...
        'position', [total_width*(1-1/2.5)-separator_offset_X,12, ...
    ...
    uiwait(fighandle);
    set(0, 'defaultuicontrolfontsize', originalfontsize);
