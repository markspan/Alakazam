classdef ToolGroup < handle
    ...
    methods
        ...
        function this = ToolGroup(apptitle, appname)
            ...
            this.FiguresDropTargetHandler = FiguresDropTargetHandler();
        ...
        function open(this)
            ...
            %setAutoSuccession(this.SwingToolstrip,false); % disable tab selection change event when a selected tab is removed
