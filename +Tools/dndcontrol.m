...
%   Version: 1.0, 13 October 2015.
    ...
    methods (Static)
        ...
        %INITJAVA Initializes the required Java class.
            ...
            if ~Tools.dndcontrol.isInitialized();
    ...
    methods
        ...
        %   callback functions for dropping of files and text.
            ...
            assert(Tools.dndcontrol.isInitialized(),'Javaclass MLDropTarget not found. Call dndcontrol.initJava() for initialization.')
             
            % Construct DropTarget            
            obj.dropTarget = handle(javaObjectEDT('MLDropTarget'),'CallbackProperties');
            set(obj.dropTarget,'DropCallback',{@Tools.dndcontrol.DndCallback,obj});
            set(obj.dropTarget,'DragEnterCallback',{@Tools.dndcontrol.DndCallback,obj});
    ...
    methods (Static)
        ...
        %   Java class is visible in the Java classpath.
            ...
            dndobj = Tools.dndcontrol(jTextArea);
