    ...
    methods (Test)
        ...
        %   another (see this class's own header comment).
            ...
            expected.('F_ERP3SG') = {'setup', 'groups-summary', 'session-n400-peak-amplitude', ...
                ...
                'combo-grouped-n400-peak-latency-a-b', 'summary-all-tests'};
            % F1 CLOSED: circular measure types now route to circularSection
            % ('circ-') instead of a linear omnibus. This census pinned the old,
            % defective routing, and contradicted QuartoReportKnownGapTest, which
            % asserted the same chunk must not be an anova.
            expected.('F_SPEC3C') = {'setup', 'anova-10hz-power', 'combo-10hz-power-a-b', ...
                ...
                'circ-10hz-phase', 'combo-desc-10hz-phase-a-b', 'summary-all-tests'};
            % F1 CLOSED: circular measure types now route to circularSection
            % ('circ-') instead of a linear omnibus. This census pinned the old,
            % defective routing, and contradicted QuartoReportKnownGapTest, which
            % asserted the same chunk must not be an anova.
            expected.('F_SPEC3CR') = {'setup', 'anova-10hz-power', 'combo-10hz-power-a-b', ...
                ...
                'anova-10hz-snr', 'combo-10hz-snr-a-b', ...
                'anova-10hz-itc', 'combo-10hz-itc-a-b', ...
                'circ-10hz-phase', 'combo-desc-10hz-phase-a-b', ...
                'anova-10hz-coherence', 'combo-10hz-coherence-a-b', ...
                'circ-10hz-phaselag', 'combo-desc-10hz-phaselag-a-b', 'summary-all-tests'};
