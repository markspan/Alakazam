...
%    2016-12-09: Fixes for recent Matlab releases, up to R2020b
%
% See also:
...
% $Revision: 1.5 $  $Date: 2020/12/09 23:17:32 $
  ...
  try
      ...
      if dockIntoButtonFlag
          ...
          hContainer = desktop.addGroup(group); %.getGroupContainer(group); %Yair 7/12/20 based on T. Flick's suggestion

          % Make the group container's callbacks accessible
          hContainer = handle(hContainer,'CallbackProperties');
